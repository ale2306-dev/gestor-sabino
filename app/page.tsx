        ...
        <>
          ...
          <form method="GET" className="w-full max-w-5xl flex gap-2">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 text-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400"
            />
            <button
              type="submit"
                        ...
                        <>
                          ...
                          <td className="py-3 px-3 md:px-6 text-center">
                            <div className="flex item-center justify-center">
                              <a href={`/edit/${item.id}`}>
                                <button className="w-4 mr-2 transform hover:text-gray-500 hover:scale-110 cursor-pointer">
