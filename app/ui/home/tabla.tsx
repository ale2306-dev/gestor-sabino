...
export default function InvoiceTable(){
  ...
  return (
    // Contenedor principal: Centra la tabla en toda la pantalla
        ...
        <table className="w-full table-auto">
          <thead className="bg-gray-800 text-white uppercase text-sm leading-normal">
            <tr>
              ...
              <th className="py-3 px-6 text-center">Fecha Despacho</th>
              <th className="py-3 px-6 text-center">Fecha Pago</th>
              <th className="py-3 px-6 text-center">Días sin Pagar</th>
